...
const RolePermissionsContent: React.FC<RolePermissionsContentProps> = ({
  ...
  useEffect(() => {
    if (preSelectedRoleId && roles.length > 0) {
      const roleExists = roles.find((role) => role.id === preSelectedRoleId);
      if (roleExists) {
        setSelectedRole(preSelectedRoleId.toString());
      }
    }
          ...
          <Box>
            <Table.ScrollContainer minWidth={800}>
              <Table striped highlightOnHover>
                <Table.Thead>
                  <Table.Tr style={{ background: "rgba(102, 126, 234, 0.1)" }}>
                ...
                <Table.Tbody>
                    ...
                    <Table.Td style={{ textAlign: "center", width: "15%" }}>
                      <Tooltip label="Select/Deselect all Add permissions">
                        <Checkbox
                          ...
                          indeterminate={isGlobalPermissionIndeterminate("add")}
                  ...
                  <Table.Tr>
                    <Table.Td
                      colSpan={5}
                      style={{ height: "8px", background: "rgba(0,0,0,0.02)" }}
                    />
                  </Table.Tr>
