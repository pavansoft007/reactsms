...
db.fee_groups = require("./feeGroup.model.js")(sequelize, Sequelize);
db.fee_groups_details = require("./feeGroupDetails.model.js")(sequelize, Sequelize);
db.fee_allocation = require("./feeAllocation.model.js")(sequelize, Sequelize);
db.fee_payment_history = require("./feePaymentHistory.model.js")(sequelize, Sequelize);
db.payment_types = require("./paymentTypes.model.js")(sequelize, Sequelize);
